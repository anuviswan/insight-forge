...
const mockUser: UserProfile = {
  ...
  avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&h=150&q=80', // Premium profile image
  ...
  blogger: {
    async generate(topic: string): Promise<BlogPost> {
      ...
      return {
        ...
        wordCount: 432,
        readTime: '2m',
        imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80' // Premium abstract design image
      };
    }
  },
